...
impl CorInfoHelpFunc {
    ...
    pub const NEWFAST_MAYBEFROZEN: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_NEWFAST_MAYBEFROZEN);
    ...
    pub const NEWSFAST_ALIGN8_FINALIZE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_NEWSFAST_ALIGN8_FINALIZE);
    ...
    pub const NEWARR_1_MAYBEFROZEN: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_NEWARR_1_MAYBEFROZEN);
    ...
    pub const ISINSTANCEOFINTERFACE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_ISINSTANCEOFINTERFACE);
    ...
    pub const CHKCASTCLASS_SPECIAL: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHKCASTCLASS_SPECIAL);
    pub const ISINSTANCEOF_EXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_ISINSTANCEOF_EXCEPTION);
    ...
    pub const METHOD_ACCESS_EXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_METHOD_ACCESS_EXCEPTION);
    pub const FIELD_ACCESS_EXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_FIELD_ACCESS_EXCEPTION);
    pub const CLASS_ACCESS_EXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CLASS_ACCESS_EXCEPTION);
    ...
    pub const GETCLASSFROMMETHODPARAM: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETCLASSFROMMETHODPARAM);
    pub const GETSYNCFROMCLASSHANDLE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETSYNCFROMCLASSHANDLE);
    ...
    pub const GETSTATICFIELDADDR_TLS: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETSTATICFIELDADDR_TLS);
    pub const GET_GCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_GCSTATIC_BASE);
    pub const GET_NONGCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_NONGCSTATIC_BASE);
    pub const GETDYNAMIC_GCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_GCSTATIC_BASE);
    pub const GETDYNAMIC_NONGCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_NONGCSTATIC_BASE);
    pub const GETPINNED_GCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETPINNED_GCSTATIC_BASE);
    pub const GETPINNED_NONGCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETPINNED_NONGCSTATIC_BASE);
    pub const GET_GCSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_GCSTATIC_BASE_NOCTOR);
    pub const GET_NONGCSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_NONGCSTATIC_BASE_NOCTOR);
    pub const GETDYNAMIC_GCSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_GCSTATIC_BASE_NOCTOR);
    pub const GETDYNAMIC_NONGCSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_NONGCSTATIC_BASE_NOCTOR);
    pub const GETPINNED_GCSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETPINNED_GCSTATIC_BASE_NOCTOR);
    pub const GETPINNED_NONGCSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETPINNED_NONGCSTATIC_BASE_NOCTOR);
    pub const GET_GCTHREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_GCTHREADSTATIC_BASE);
    pub const GET_NONGCTHREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_NONGCTHREADSTATIC_BASE);
    pub const GETDYNAMIC_GCTHREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_GCTHREADSTATIC_BASE);
    pub const GETDYNAMIC_NONGCTHREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_NONGCTHREADSTATIC_BASE);
    pub const GET_GCTHREADSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_GCTHREADSTATIC_BASE_NOCTOR);
    pub const GET_NONGCTHREADSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GET_NONGCTHREADSTATIC_BASE_NOCTOR);
    pub const GETDYNAMIC_GCTHREADSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_GCTHREADSTATIC_BASE_NOCTOR);
    pub const GETDYNAMIC_NONGCTHREADSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_NONGCTHREADSTATIC_BASE_NOCTOR);
    pub const GETDYNAMIC_GCTHREADSTATIC_BASE_NOCTOR_OPTIMIZED: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_GCTHREADSTATIC_BASE_NOCTOR_OPTIMIZED);
    pub const GETDYNAMIC_NONGCTHREADSTATIC_BASE_NOCTOR_OPTIMIZED: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_NONGCTHREADSTATIC_BASE_NOCTOR_OPTIMIZED);
    pub const GETDYNAMIC_NONGCTHREADSTATIC_BASE_NOCTOR_OPTIMIZED2: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDYNAMIC_NONGCTHREADSTATIC_BASE_NOCTOR_OPTIMIZED2);
    ...
    pub const GETDIRECTONTHREADLOCALDATA_NONGCTHREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETDIRECTONTHREADLOCALDATA_NONGCTHREADSTATIC_BASE);
    pub const DBG_IS_JUST_MY_CODE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_DBG_IS_JUST_MY_CODE);
    ...
    pub const GETCURRENTMANAGEDTHREADID: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GETCURRENTMANAGEDTHREADID);
    ...
    pub const RUNTIMEHANDLE_METHOD: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_RUNTIMEHANDLE_METHOD);
    pub const RUNTIMEHANDLE_CLASS: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_RUNTIMEHANDLE_CLASS);
    pub const TYPEHANDLE_TO_RUNTIMETYPE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_TYPEHANDLE_TO_RUNTIMETYPE);
    pub const METHODDESC_TO_STUBRUNTIMEMETHOD: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_METHODDESC_TO_STUBRUNTIMEMETHOD);
    pub const FIELDDESC_TO_STUBRUNTIMEFIELD: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_FIELDDESC_TO_STUBRUNTIMEFIELD);
    pub const TYPEHANDLE_TO_RUNTIMETYPEHANDLE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_TYPEHANDLE_TO_RUNTIMETYPEHANDLE);
    ...
    pub const READYTORUN_NEWARR_1: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_NEWARR_1);
    pub const READYTORUN_ISINSTANCEOF: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_ISINSTANCEOF);
    pub const READYTORUN_CHKCAST: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_CHKCAST);
    pub const READYTORUN_GCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_GCSTATIC_BASE);
    pub const READYTORUN_NONGCSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_NONGCSTATIC_BASE);
    pub const READYTORUN_THREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_THREADSTATIC_BASE);
    pub const READYTORUN_THREADSTATIC_BASE_NOCTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_THREADSTATIC_BASE_NOCTOR);
    pub const READYTORUN_NONGCTHREADSTATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_NONGCTHREADSTATIC_BASE);
    pub const READYTORUN_VIRTUAL_FUNC_PTR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_VIRTUAL_FUNC_PTR);
    pub const READYTORUN_GENERIC_HANDLE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_GENERIC_HANDLE);
    pub const READYTORUN_DELEGATE_CTOR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_DELEGATE_CTOR);
    pub const READYTORUN_GENERIC_STATIC_BASE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_READYTORUN_GENERIC_STATIC_BASE);
    pub const EE_PERSONALITY_ROUTINE: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_EE_PERSONALITY_ROUTINE);
    pub const EE_PERSONALITY_ROUTINE_FILTER_FUNCLET: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_EE_PERSONALITY_ROUTINE_FILTER_FUNCLET);
    ...
    pub const CHECKED_ASSIGN_REF_EAX: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHECKED_ASSIGN_REF_EAX);
    pub const CHECKED_ASSIGN_REF_EBX: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHECKED_ASSIGN_REF_EBX);
    pub const CHECKED_ASSIGN_REF_ECX: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHECKED_ASSIGN_REF_ECX);
    pub const CHECKED_ASSIGN_REF_ESI: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHECKED_ASSIGN_REF_ESI);
    pub const CHECKED_ASSIGN_REF_EDI: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHECKED_ASSIGN_REF_EDI);
    pub const CHECKED_ASSIGN_REF_EBP: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_CHECKED_ASSIGN_REF_EBP);
    pub const LOOP_CLONE_CHOICE_ADDR: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_LOOP_CLONE_CHOICE_ADDR);
    pub const DEBUG_LOG_LOOP_CLONING: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_DEBUG_LOG_LOOP_CLONING);
    pub const THROW_ARGUMENTEXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_ARGUMENTEXCEPTION);
    pub const THROW_ARGUMENTOUTOFRANGEEXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_ARGUMENTOUTOFRANGEEXCEPTION);
    pub const THROW_NOT_IMPLEMENTED: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_NOT_IMPLEMENTED);
    pub const THROW_PLATFORM_NOT_SUPPORTED: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_PLATFORM_NOT_SUPPORTED);
    pub const THROW_TYPE_NOT_SUPPORTED: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_TYPE_NOT_SUPPORTED);
    pub const THROW_AMBIGUOUS_RESOLUTION_EXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_AMBIGUOUS_RESOLUTION_EXCEPTION);
    pub const THROW_ENTRYPOINT_NOT_FOUND_EXCEPTION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_THROW_ENTRYPOINT_NOT_FOUND_EXCEPTION);
    ...
    pub const JIT_REVERSE_PINVOKE_ENTER: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_JIT_REVERSE_PINVOKE_ENTER);
    pub const JIT_REVERSE_PINVOKE_ENTER_TRACK_TRANSITIONS: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_JIT_REVERSE_PINVOKE_ENTER_TRACK_TRANSITIONS);
    pub const JIT_REVERSE_PINVOKE_EXIT: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_JIT_REVERSE_PINVOKE_EXIT);
    pub const JIT_REVERSE_PINVOKE_EXIT_TRACK_TRANSITIONS: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_JIT_REVERSE_PINVOKE_EXIT_TRACK_TRANSITIONS);
    pub const GVMLOOKUP_FOR_SLOT: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_GVMLOOKUP_FOR_SLOT);
    pub const INTERFACEDISPATCH_FOR_SLOT: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_INTERFACEDISPATCH_FOR_SLOT);
    pub const INTERFACELOOKUP_FOR_SLOT: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_INTERFACELOOKUP_FOR_SLOT);
    ...
    pub const VALIDATE_INDIRECT_CALL: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_VALIDATE_INDIRECT_CALL);
    pub const DISPATCH_INDIRECT_CALL: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_DISPATCH_INDIRECT_CALL);
    pub const ALLOC_CONTINUATION: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_ALLOC_CONTINUATION);
    pub const ALLOC_CONTINUATION_METHOD: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_ALLOC_CONTINUATION_METHOD);
    pub const ALLOC_CONTINUATION_CLASS: Self = Self(ffi::CorInfoHelpFunc_CORINFO_HELP_ALLOC_CONTINUATION_CLASS);
}
