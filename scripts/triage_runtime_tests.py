...
BUCKET_RULES: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"thread-local statics|static field of a shared-generic|static field through an address helper|static field accessor outside|static field needing an access callout|static field address through an indirection cell|generic statics helper|statics-base helper|shared statics base|empty string through multiple indirections"), "statics residual gates (11.7: R2R/deep-indirection dynamic-info)"),
